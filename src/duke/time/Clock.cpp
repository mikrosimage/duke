...
Metronom::Metronom(size_t values) : m_Size(values), m_Min(0), m_Max(0), m_Mean(0), m_StdDev(0) {}

std::chrono::microseconds Metronom::tick() {
  if (m_Durations.size() >= m_Size) m_Durations.pop_front();
