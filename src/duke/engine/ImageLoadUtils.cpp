...
std::string loadImage(IImageReader *pRawReader, const LoadCallback& callback) {
...
std::string tryReader(const char* filename, const IIODescriptor *pDescriptor, const LoadCallback& callback) {
...
std::string load(const char* pFilename, const char *pExtension, const LoadCallback& callback) {
