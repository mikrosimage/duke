...
struct VertexPosUv0 {
  glm::vec3 position;
  glm::vec2 uv0;
  VertexPosUv0(glm::vec3 pos) : position(pos) {}
  VertexPosUv0(glm::vec3 pos, glm::vec2 uv0) : position(pos), uv0(uv0) {}
};
...
class Mesh : public gl::IBindable {
 public:
  ...
  gl::Binder<Mesh> scope_bind() const {
    return {this};
  }
...
class IndexedMesh : public Mesh {
 public:
  IndexedMesh(GLuint primitiveType, const VertexPosUv0 *pVBegin, const size_t vertexCount, const GLuint *pIBegin,
