...
void Program::glUniform4f(const char* pUniformName, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) {
	...
	if (update(entry.data, data))
		::glUniform4f(entry.location, v0, v1, v2, v3);
}
