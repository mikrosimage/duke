...
SharedFragmentShader makeFragmentShader(const char* pSource) { return std::make_shared<FragmentShader>(pSource); }

SharedVertexShader makeVertexShader(const char* pSource) { return std::make_shared<VertexShader>(pSource); }
