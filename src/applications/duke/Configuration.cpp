...
Configuration::Configuration(int argc, char** argv) :
    ...
    (CACHE_SIZE, po::value<size_t>()->default_value(0), "Cache size for look ahead read in MiB.\n0 means no caching.") //
    (THREADS, po::value<size_t>()->default_value(1), "Number of load/decode threads. Cache size must be >0.");
