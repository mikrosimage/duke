...
int main( int argc, char** argv )
{
	...
	ofstream file( argv[1], ofstream::out | ofstream::binary );
	{
		...
		//		playlist.add_paths("F:\\footage\\jusquatoi_master\\JUSQUATOI\\BOB2");
		//	playlist.add_paths("F:\\footage\\rapt\\scans\\bob03");
		//		playlist.add_paths("T:\\Images\\RealTime\\dpx");
		playlist.set_recin( 0 );
		playlist.set_recout( 10000 );
		playlist.add_starts( 0 );
		playlist.add_ends( 300 );
		//playlist.add_paths("T:\\Images\\Apparition\\HalfSize");
		//playlist.add_sequences("apparition_joconde_001_#####.dpx[08000-08300]");

		playlist.add_sequences( "Linsurge_BOB3.#######.dpx[275300-275600]" );
		//	playlist.add_sequences("bob03.#######.dpx[55077-83711]");

		//		playlist.add_sequences("jusquatoi.#######.dpx[105787-131055]");
		//		playlist.add_sequences("sequence_###.dpx[001-100]");
		//	playlist.add_starts(301);
		//	playlist.add_ends(601);
		...
		/*
		        //
		        // Messages RenderFrame
		        for( int img = 0; img<300; img++ ) {
		...
		Message msgPlayback;
		msgPlayback.set_type( Message_MessageType_PLAYBACK );

		::serialize::Playback playback;
		playback.set_renderpassid( 11223344 );
		//		playback.set_sequence("Linsurge_BOB3.#######.dpx[275300-275600]");
		playback.set_framerate( 32.0 );
		playback.set_refreshrate( 60.0 );
		playback.set_recin( 0 );

		playback.SerializeToString( &embeddedString );
		msgPlayback.set_data( embeddedString );
		helper.appendProtocolBufferMessage( msgPlayback );
